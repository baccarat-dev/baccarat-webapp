...
<main>
  <button style="display: none;" use:registerFocus> focus here </button>
  ...
  <div class="notfound-copy">
    ...
    <br />
    <h1><a href="/login">Back to login</a></h1>
  </div>
  ...
  <svg aria-labelledby="Starry sky" alt="Starry sky" class="starry-sky">
    ...
    <g class="moon">
      ...
      <g fill="#D1D5D6">
        ...
        /><circle cx="256.3" cy="384.3" r="14.1" /></g
      ><g fill="#FFF"
        ><circle cx="217.1" cy="477.1" r="24" /><path
